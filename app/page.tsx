...
export default function Home() {
  ...
  return (
    <div className="relative text-white">
      ...
      <section id="industries" className="min-h-screen bg-black/30 py-20 px-6">
      ...
      <section className="min-h-screen bg-black/30 py-20 px-6 flex items-center">
      ...
      <section className="min-h-screen bg-black/30 py-20 px-6">
      ...
      {/* SECTION 5: PRODUCTS */}
      <section id="products" className="min-h-screen bg-black/30 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
      ...
      {/* SECTION 6: ABOUT */}
      <section id="about" className="min-h-screen bg-black/30 py-20 px-6 flex items-center">
        <div className="max-w-7xl mx-auto w-full">
      ...
      {/* SECTION 7: CONTACT */}
      <section id="contact" className="min-h-screen bg-black/30 py-20 px-6 flex items-center">
        <div className="max-w-7xl mx-auto w-full">
          <motion.div className="text-center mb-16" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
